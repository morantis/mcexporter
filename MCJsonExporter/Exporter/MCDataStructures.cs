...
namespace Exporter
{
    public class MCDataStructures
    {
        ...
        public class Attributes
        {
            ...
            [JsonProperty(PropertyName = "minecraft:attack", NullValueHandling = NullValueHandling.Ignore, DefaultValueHandling = DefaultValueHandling.Ignore)]
            public Minecraft_attack Attack { get; set; }

            [JsonProperty(PropertyName = "minecraft:spell_effects", NullValueHandling = NullValueHandling.Ignore, DefaultValueHandling = DefaultValueHandling.Ignore)]
            public Minecraft_spell_effects SpellEffects { get; set; }

            [JsonProperty(PropertyName = "minecraft:strength", NullValueHandling = NullValueHandling.Ignore, DefaultValueHandling = DefaultValueHandling.Ignore)]

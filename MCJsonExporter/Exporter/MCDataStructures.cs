...
namespace Exporter
{
    public class MCDataStructures
    {
        ...
        {
            [JsonProperty(PropertyName = "table", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public class EntityTypesSub
        {
            ...
            [JsonProperty(PropertyName = "max_dist", NullValueHandling = NullValueHandling.Ignore)]
            public float max_dist { get; set; } // 16	Maximum distance this mob can be away to be a valid choice

            [JsonProperty(PropertyName = "must_see", NullValueHandling = NullValueHandling.Ignore)]
            public bool must_see { get; set; } // Boolean false	If true, the mob has to be visible to be a valid choice

            [JsonProperty(PropertyName = "sprint_speed_multiplier", NullValueHandling = NullValueHandling.Ignore)]
            ...
            [JsonProperty(PropertyName = "walk_speed_multiplier", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public class Attributes
        {
            public class Minecraft_attack
            {
                ...
                [JsonProperty(PropertyName = "damage", NullValueHandling = NullValueHandling.Ignore)]
                public float[] Damage;

                [JsonProperty(PropertyName = "effect_duration", NullValueHandling = NullValueHandling.Ignore)]
                public float Effect_duration { get; set; } // {get; set;} //	0.0	Duration in seconds of the status ailment applied to the damaged entity

                [JsonProperty(PropertyName = "effect_name", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_spell_effects
            {
                ...
                [JsonProperty(PropertyName = "remove_effects", NullValueHandling = NullValueHandling.Ignore)]
            ...
            [JsonProperty(PropertyName = "minecraft:attack", NullValueHandling = NullValueHandling.Ignore)]
            public Minecraft_attack Attack { get; set; }

            [JsonProperty(PropertyName = "minecraft:spell_effects", NullValueHandling = NullValueHandling.Ignore)]
            public Minecraft_spell_effects SpellEffects { get; set; }

            [JsonProperty(PropertyName = "minecraft:strength", NullValueHandling = NullValueHandling.Ignore)]
            public Minecraft_strength Strength { get; set; }
        }
        ...
        public class Components
        {
            ...
            public class Minecraft_addrider
            {
                ...
                [JsonProperty(PropertyName = "entity_pipe", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_angry
            {
                ...
                [JsonProperty(PropertyName = "broadcastAnger", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "broadcastRage", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "calm_event", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_boostable
            {
                public class Boost_items
                {
                    ...
                    [JsonProperty(PropertyName = "replaceItem", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_breathable
            {
                ...
                [JsonProperty(PropertyName = "breathesLava", NullValueHandling = NullValueHandling.Ignore)]
                public bool BreathesLava { get; set; } //	If true, this entity can breathe in lava

                [JsonProperty(PropertyName = "breathesSolids", NullValueHandling = NullValueHandling.Ignore)]
                public bool BreathesSolids { get; set; } //	If true, this entity can breathe in solid blocks

                [JsonProperty(PropertyName = "breathesWater", NullValueHandling = NullValueHandling.Ignore)]
                public bool BreathesWater { get; set; } //	If true, this entity can breathe in water

                [JsonProperty(PropertyName = "generatesBubbles", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "totalSupply", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_breedable
            {
                ...
                [JsonProperty(PropertyName = "allowSitting", NullValueHandling = NullValueHandling.Ignore)]
                public bool AllowSitting { get; set; } // {get; set;} // Boolean	false	If true, entities can breed while sitting

                [JsonProperty(PropertyName = "breedCooldown", NullValueHandling = NullValueHandling.Ignore)]
                ...
                {
                    [JsonProperty(PropertyName = "babyType", NullValueHandling = NullValueHandling.Ignore)]
                    public string babyType { get; set; } // {get; set;} // String  The entity definition of this entity's babies

                    [JsonProperty(PropertyName = "breed_event", NullValueHandling = NullValueHandling.Ignore)]
                    public string breed_event { get; set; } // {get; set;} // String       Event to run when this entity breeds

                    [JsonProperty(PropertyName = "mateType", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "inheritTamed", NullValueHandling = NullValueHandling.Ignore)]
                ...
                public class Mutation_factorSub
                {
                    ...
                    [JsonProperty(PropertyName = "extra_variant", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "mutation_factor", NullValueHandling = NullValueHandling.Ignore)]
                public Mutation_factorSub Mutation_factor { get; set; }

                [JsonProperty(PropertyName = "requireTame", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_damage_sensor
            {
                ...
                [JsonProperty(PropertyName = "cause", NullValueHandling = NullValueHandling.Ignore)]
                public string cause { get; set; } // {get; set;} // String  Type of damage that triggers this set of events

                [JsonProperty(PropertyName = "deals_damage", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "on_damage", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_equippable
            {
                ...
                public class EquippableSub
                {
                    ...
                    [JsonProperty(PropertyName = "on_equip", NullValueHandling = NullValueHandling.Ignore)]
                    public MinecraftEvent on_equip { get; set; } // {get; set;} // String  Event to trigger when this entity is equipped with this item

                    [JsonProperty(PropertyName = "on_unequip", NullValueHandling = NullValueHandling.Ignore)]
                    public MinecraftEvent on_unequip { get; set; } // {get; set;} // String  Event to trigger when this item is removed from this entity

                    [JsonProperty(PropertyName = "slot", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_explode
            {
                ...
                [JsonProperty(PropertyName = "breaks_blocks", NullValueHandling = NullValueHandling.Ignore)]
                public bool breaks_blocks { get; set; } // Boolean	true	If true, the explosion will destroy blocks in the explosion radius

                [JsonProperty(PropertyName = "causesFire", NullValueHandling = NullValueHandling.Ignore)]
                public bool causesFire { get; set; } // Boolean false	If true, blocks in the explosion radius will be set on fire

                [JsonProperty(PropertyName = "destroyAffectedByGriefing", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "fireAffectedByGriefing", NullValueHandling = NullValueHandling.Ignore)]
                ...
                public class FuseLength
                {
                    ...
                    [JsonProperty(PropertyName = "range_min", NullValueHandling = NullValueHandling.Ignore)]
                    public float RangeMin { get; set; }

                    [JsonProperty(PropertyName = "range_max", NullValueHandling = NullValueHandling.Ignore)]
                    public float RangeMax { get; set; }
                }

                [JsonProperty(PropertyName = "fuseLength", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_healable
            {
                ...
                public class HealableSub
                {
                    ...
                    [JsonProperty(PropertyName = "force_use", NullValueHandling = NullValueHandling.Ignore)]
                    public bool force_use { get; set; } // Boolean false	Determines if item can be used regardless of entity being full health

                    [JsonProperty(PropertyName = "heal_amount", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_interact
            {
                ...
                [JsonProperty(PropertyName = "add_items", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "cooldown", NullValueHandling = NullValueHandling.Ignore)]
                public float cooldown { get; set; } //	0.0	Time in seconds before this entity can be interacted with again

                [JsonProperty(PropertyName = "hurt_item", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "on_interact", NullValueHandling = NullValueHandling.Ignore)]
                public MinecraftEvent on_interact { get; set; } // String       Event to fire when the interaction occurs

                [JsonProperty(PropertyName = "play_sounds", NullValueHandling = NullValueHandling.Ignore)]
                public string play_sounds { get; set; } // String  List of sounds to play when the interaction occurs

                [JsonProperty(PropertyName = "spawn_entities", NullValueHandling = NullValueHandling.Ignore)]
                public string spawn_entities { get; set; } // String       List of entities to spawn when the interaction occurs

                [JsonProperty(PropertyName = "spawn_items", NullValueHandling = NullValueHandling.Ignore)]
                [JsonConverter(typeof(SingleOrArrayConverter<ItemsObj>))]
                public List<ItemsObj> spawn_items { get; set; }

                [JsonProperty(PropertyName = "swing", NullValueHandling = NullValueHandling.Ignore)]
                public bool swing { get; set; } // Boolean	false	If true, the player will do the 'swing' animation when interacting with this entity

                [JsonProperty(PropertyName = "transform_to_item", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "use_item", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_inventory
            {
                ...
                [JsonProperty(PropertyName = "additional_slots_per_strength", NullValueHandling = NullValueHandling.Ignore)]
                public int additional_slots_per_strength { get; set; } // Integer 	0	Number of slots that this entity can gain per extra strength

                [JsonProperty(PropertyName = "can_be_siphoned_from", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "inventory_size", NullValueHandling = NullValueHandling.Ignore)]
                public int inventory_size { get; set; } // Integer  5	Number of slots the container has

                [JsonProperty(PropertyName = "linked_slots_size", NullValueHandling = NullValueHandling.Ignore)]
                public int linked_slots_size { get; set; } // Integer 	0	Number of linked slots (e.g.Player Hotbar) the container has

                [JsonProperty(PropertyName = "isprivate", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_leashable
            {
                ...
                [JsonProperty(PropertyName = "hard_distance", NullValueHandling = NullValueHandling.Ignore)]
                public float hard_distance { get; set; } //	6.0	Distance in blocks at which the leash stiffens, restricting movement

                [JsonProperty(PropertyName = "max_distance", NullValueHandling = NullValueHandling.Ignore)]
                public float max_distance { get; set; } //	10.0	Distance in blocks at which the leash breaks

                [JsonProperty(PropertyName = "on_leash", NullValueHandling = NullValueHandling.Ignore)]
                public MinecraftEvent on_leash { get; set; } // String       Event to call when this entity is leashed

                [JsonProperty(PropertyName = "on_unleash", NullValueHandling = NullValueHandling.Ignore)]
                public MinecraftEvent on_unleash { get; set; } // String  Event to call when this entity is unleashed

                [JsonProperty(PropertyName = "soft_distance", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_lookat
            {
                ...
                [JsonProperty(PropertyName = "look_cooldown", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "look_event", NullValueHandling = NullValueHandling.Ignore)]
                public string look_event { get; set; } // String       Event to run when the entities specified in filters look at this entity

                [JsonProperty(PropertyName = "mAllowInvulnerable", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "searchRadius", NullValueHandling = NullValueHandling.Ignore)]
                public float searchRadius { get; set; } // 10.0	Maximum distance this entity will look for another entity looking at it

                [JsonProperty(PropertyName = "setTarget", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_movement_basic
            {
                ...
                [JsonProperty(PropertyName = "max_turn", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_movement_jump
            {
                ...
                [JsonProperty(PropertyName = "jump_delay", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_nameable
            {
                ...
                [JsonProperty(PropertyName = "name_actions", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_navigation_climb
            {
                ...
                [JsonProperty(PropertyName = "avoid_portals", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "avoid_sun", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "can_float", NullValueHandling = NullValueHandling.Ignore)]
                public bool can_float { get; set; } // Boolean	false	Tells the pathfinder whether or not it can float in water

                [JsonProperty(PropertyName = "can_open_doors", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "can_pass_doors", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_peek
            {
                ...
                [JsonProperty(PropertyName = "on_close", NullValueHandling = NullValueHandling.Ignore)]
                public MinecraftEvent on_close { get; set; } // String  Event to call when the entity is done peeking

                [JsonProperty(PropertyName = "on_open", NullValueHandling = NullValueHandling.Ignore)]
                public MinecraftEvent on_open { get; set; } // String  Event to call when the entity starts peeking

                [JsonProperty(PropertyName = "on_target_open", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_projectile
            {
                ...
                [JsonProperty(PropertyName = "angleoffset", NullValueHandling = NullValueHandling.Ignore)]
                public float angleoffset { get; set; } //	0.0	Determines the angle at which the projectile is thrown

                [JsonProperty(PropertyName = "catchFire", NullValueHandling = NullValueHandling.Ignore)]
                public bool catchFire { get; set; } // Boolean	false	If true, the entity hit will be set on fire

                [JsonProperty(PropertyName = "critParticleOnHurt", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "destroyOnHurt", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "gravity", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "onFireTime", NullValueHandling = NullValueHandling.Ignore)]
                public float onFireTime { get; set; } //	5.0	Time in seconds that the entity hit will be on fire for

                [JsonProperty(PropertyName = "particle", NullValueHandling = NullValueHandling.Ignore)]
                public string particle { get; set; } // String  iconcrack Particle to use upon collision

                [JsonProperty(PropertyName = "potionEffect", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "reflectOnHurt", NullValueHandling = NullValueHandling.Ignore)]
                public bool reflectOnHurt { get; set; } // Boolean	false	If true, this entity will be reflected back when hit

                [JsonProperty(PropertyName = "semirandomdiffdamage", NullValueHandling = NullValueHandling.Ignore)]
                public bool semirandomdiffdamage { get; set; } // Boolean	false	If true, damage will be randomized based on damage and speed

                [JsonProperty(PropertyName = "shootSound", NullValueHandling = NullValueHandling.Ignore)]
                public string shootSound { get; set; } // String  The sound that plays when the projectile is shot

                [JsonProperty(PropertyName = "shoottarget", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "shouldbounce", NullValueHandling = NullValueHandling.Ignore)]
                public bool shouldbounce { get; set; } // Boolean	false	If true, the projectile will bounce upon hit

                [JsonProperty(PropertyName = "splashPotion", NullValueHandling = NullValueHandling.Ignore)]
                public bool splashPotion { get; set; } // Boolean	false	If true, the projectile will be treated like a splash potion

                [JsonProperty(PropertyName = "splashRange", NullValueHandling = NullValueHandling.Ignore)]
                public float splashRange { get; set; } //	4.0	Radius in blocks of the 'splash' effect

                [JsonProperty(PropertyName = "uncertaintyBase", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "uncertaintyMultiplier", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_rail_movement
            {
                ...
                [JsonProperty(PropertyName = "max_speed", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_rail_sensor
            {
                ...
                [JsonProperty(PropertyName = "check_block_types", NullValueHandling = NullValueHandling.Ignore)]
                public bool check_block_types { get; set; } // Boolean	false	If true, on tick this entity will trigger its on_deactivate behavior

                [JsonProperty(PropertyName = "eject_on_activate", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "eject_on_deactivate", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "on_activate", NullValueHandling = NullValueHandling.Ignore)]
                public MinecraftEvent on_activate { get; set; } // String  Event to call when the rail is activated

                [JsonProperty(PropertyName = "on_deactivate", NullValueHandling = NullValueHandling.Ignore)]
                public MinecraftEvent on_deactivate { get; set; } // String  Event to call when the rail is deactivated

                [JsonProperty(PropertyName = "tick_command_block_on_activate", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "tick_command_block_on_deactivate", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_rideable
            {
                ...
                [JsonProperty(PropertyName = "controlling_seat", NullValueHandling = NullValueHandling.Ignore)]
                public int controlling_seat { get; set; } // Integer 	0	The seat that designates the driver of the entity

                [JsonProperty(PropertyName = "crouching_skip_interact", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "pull_in_entities", NullValueHandling = NullValueHandling.Ignore)]
                ...
                {
                    [JsonProperty(PropertyName = "lock_rider_rotation", NullValueHandling = NullValueHandling.Ignore)]
                    ...
                    [JsonProperty(PropertyName = "max_rider_count", NullValueHandling = NullValueHandling.Ignore)]
                    ...
                    [JsonProperty(PropertyName = "min_rider_count", NullValueHandling = NullValueHandling.Ignore)]
                    ...
                    [JsonProperty(PropertyName = "rotate_rider_by", NullValueHandling = NullValueHandling.Ignore)]
                    public float rotate_rider_by { get; set; } //	0.0	Offset to rotate riders by
                }

                [JsonProperty(PropertyName = "seats", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_scale_by_age
            {
                ...
                [JsonProperty(PropertyName = "end_scale", NullValueHandling = NullValueHandling.Ignore)]
                public float end_scale { get; set; } //	1.0	Ending scale of the entity when it's fully grown

                [JsonProperty(PropertyName = "start_scale", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_shareables
            {
                ...
                [JsonProperty(PropertyName = "craft_into", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "surplus_amount", NullValueHandling = NullValueHandling.Ignore)]
                public int surplus_amount { get; set; } // Integer 	-1	Number of this item considered extra that the entity wants to share

                [JsonProperty(PropertyName = "want_amount", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_shooter
            {
                ...
                [JsonProperty(PropertyName = "auxVal", NullValueHandling = NullValueHandling.Ignore)]
                public int auxVal { get; set; } // Integer 	-1	ID of the Potion effect to be applied on hit

                [JsonProperty(PropertyName = "def", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_sittable
            {
                ...
                [JsonProperty(PropertyName = "sit_event", NullValueHandling = NullValueHandling.Ignore)]
                public string sit_event { get; set; } // String  Event to run when the entity enters the 'sit' state

                [JsonProperty(PropertyName = "stand_event", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_spawn_entity
            {
                ...
                [JsonProperty(PropertyName = "max_wait_time", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "min_wait_time", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "spawn_entity", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "spawn_event", NullValueHandling = NullValueHandling.Ignore)]
                public string spawn_event { get; set; } // String  public class Minecraft_entity_born Event to call when the entity is spawned

                [JsonProperty(PropertyName = "spawn_item", NullValueHandling = NullValueHandling.Ignore)]
                public string spawn_item { get; set; } // String  egg Name of the item to spawn

                [JsonProperty(PropertyName = "spawn_method", NullValueHandling = NullValueHandling.Ignore)]
                public string spawn_method { get; set; } // String  born Method to use to spawn the entity

                [JsonProperty(PropertyName = "spawn_sound", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_tamemount
            {
                ...
                [JsonProperty(PropertyName = "attemptTemperMod", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "autoRejectItems", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "feed_text", NullValueHandling = NullValueHandling.Ignore)]
                public string feed_text { get; set; } // String  The text that shows in the feeding interact button

                [JsonProperty(PropertyName = "maxTemper", NullValueHandling = NullValueHandling.Ignore)]
                public int maxTemper { get; set; } // Integer  100 The maximum value for the entity's random starting temper

                [JsonProperty(PropertyName = "minTemper", NullValueHandling = NullValueHandling.Ignore)]
                public string minTemper { get; set; } // Integer  0   The minimum value for the entity's random starting temper

                [JsonProperty(PropertyName = "ride_text", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_target_nearby_sensor
            {
                ...
                [JsonProperty(PropertyName = "inside_range", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "on_inside_range", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "on_outside_range", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "outside_range", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_teleport
            {
                ...
                [JsonProperty(PropertyName = "darkTeleportChance", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "lightTeleportChance", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "maxRandomTeleportTime", NullValueHandling = NullValueHandling.Ignore)]
                public float maxRandomTeleportTime { get; set; } // 20.0    Maximum amount of time in seconds between random teleports

                [JsonProperty(PropertyName = "minRandomTeleportTime", NullValueHandling = NullValueHandling.Ignore)]
                public float minRandomTeleportTime { get; set; } // 0.0 Minimum amount of time in seconds between random teleports

                [JsonProperty(PropertyName = "randomTeleportCube", NullValueHandling = NullValueHandling.Ignore)]
                public float[] randomTeleportCube { get; set; } // Entity will teleport to a random position within the area defined by this cube

                [JsonProperty(PropertyName = "randomTeleports", NullValueHandling = NullValueHandling.Ignore)]
                public bool randomTeleports { get; set; } // Boolean	true	If true, the entity will teleport randomly

                [JsonProperty(PropertyName = "targetDistance", NullValueHandling = NullValueHandling.Ignore)]
                public float targetDistance { get; set; } //	16.0	Maximum distance the entity will teleport when chasing a target

                [JsonProperty(PropertyName = "target_teleport_chance", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_tick_world
            {
                ...
                [JsonProperty(PropertyName = "distance_to_players", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "never_despawn", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_timer
            {
                ...
                [JsonProperty(PropertyName = "looping", NullValueHandling = NullValueHandling.Ignore)]
                public bool looping { get; set; } // Boolean	true	If true, the timer will restart every time after it fires

                [JsonProperty(PropertyName = "randomInterval", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "time_down_event", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_transformation
            {
                ...
                [JsonProperty(PropertyName = "begin_transform_sound", NullValueHandling = NullValueHandling.Ignore)]
                public string begin_transform_sound { get; set; } // String       Sound to play when the transformation starts

                public class DelaySub
                {
                    [JsonProperty(PropertyName = "block_assist_chance", NullValueHandling = NullValueHandling.Ignore)]
                    ...
                    [JsonProperty(PropertyName = "block_chance", NullValueHandling = NullValueHandling.Ignore)]
                    public float block_chance { get; set; } // 0.0 Chance that, once a block is found, will help speed up the transformation

                    [JsonProperty(PropertyName = "block_max", NullValueHandling = NullValueHandling.Ignore)]
                    ...
                    [JsonProperty(PropertyName = "block_radius", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "into", NullValueHandling = NullValueHandling.Ignore)]
                public string into { get; set; } // String       Entity Definition that this entity will transform into

                [JsonProperty(PropertyName = "transformation_sound", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_avoid_mob_type
            {
                ...
                [JsonProperty(PropertyName = "probability_per_strength", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_find_mount
            {
                ...
                [JsonProperty(PropertyName = "mount_distance", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "start_delay", NullValueHandling = NullValueHandling.Ignore)]
                public int start_delay { get; set; } // Integer 	0	Time the mob will wait before starting to move towards the mount

                [JsonProperty(PropertyName = "target_needed", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_float_wander
            {
                ...
                [JsonProperty(PropertyName = "must_reach", NullValueHandling = NullValueHandling.Ignore)]
                public bool must_reach { get; set; } // Boolean	false	If true, the point has to be reachable to be a valid target

                [JsonProperty(PropertyName = "random_reselect", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "y_dist", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "y_offset", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_follow_mob
            {
                ...
                [JsonProperty(PropertyName = "stop_distance", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_hurt_by_target
            {
                ...
                [JsonProperty(PropertyName = "hurt_owner", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_leap_at_target
            {
                ...
                [JsonProperty(PropertyName = "yd", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_look_at_entity
            {
                ...
                [JsonProperty(PropertyName = "angle_of_view_vertical", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_melee_attack
            {
                ...
                [JsonProperty(PropertyName = "random_stop_interval", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "reach_multiplier", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "track_target", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_mount_pathing
            {
                ...
                [JsonProperty(PropertyName = "target_dist", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_nearest_attackable_target
            {
                ...
                [JsonProperty(PropertyName = "must_see_forget_duration", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "reselect_targets", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_raid_garden
            {
                ...
                [JsonProperty(PropertyName = "full_delay", NullValueHandling = NullValueHandling.Ignore)]
                public int full_delay { get; set; } // Integer 	100	Amount of time in seconds before this mob wants to eat again

                [JsonProperty(PropertyName = "goal_radius", NullValueHandling = NullValueHandling.Ignore)]
                public float goal_radius { get; set; } // 0.5	Distance in blocks within the mob considers it has reached the goal. This is the "wiggle room" to stop the AI from bouncing back and forth trying to reach a specific spot

                [JsonProperty(PropertyName = "max_to_eat", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_ranged_attack
            {
                ...
                [JsonProperty(PropertyName = "attack_interval_min", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "attack_radius", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "burst_interval", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "burst_shots", NullValueHandling = NullValueHandling.Ignore)]
                public int burst_shots { get; set; } // Integer  1	Number of shots fired every time the mob uses a charged attack

                [JsonProperty(PropertyName = "charge_charged_trigger", NullValueHandling = NullValueHandling.Ignore)]
                ...
                [JsonProperty(PropertyName = "charge_shoot_trigger", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_send_event
            {
                ...
                {
                    [JsonProperty(PropertyName = "base_delay", NullValueHandling = NullValueHandling.Ignore)]
                    ...
                    [JsonProperty(PropertyName = "sound_event", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public class Minecraft_behavior_summon_entity
            {
                ...
                public class SummonChoicesSub
                {
                    ...
                    [JsonProperty(PropertyName = "cooldown_time", NullValueHandling = NullValueHandling.Ignore)]
                    ...
                    [JsonProperty(PropertyName = "max_activation_range", NullValueHandling = NullValueHandling.Ignore)]
                    public float max_activation_range { get; set; } //	-1.0	Upper bound of the activation distance in blocks for this spell

                    [JsonProperty(PropertyName = "min_activation_range", NullValueHandling = NullValueHandling.Ignore)]
                    public float min_activation_range { get; set; } // 1.0	Lower bound of the activation distance in blocks for this spell

                    [JsonProperty(PropertyName = "particle_color", NullValueHandling = NullValueHandling.Ignore)]
                    ...
                    public class SequenceSub
                    {
                        ...
                        [JsonProperty(PropertyName = "delay_per_summon", NullValueHandling = NullValueHandling.Ignore)]
                        public float delay_per_summon { get; set; } //	0.0	Amount of time in seconds before each entity is summoned in this step

                        [JsonProperty(PropertyName = "entity_lifespan", NullValueHandling = NullValueHandling.Ignore)]
                        ...
                        [JsonProperty(PropertyName = "Entity_type", NullValueHandling = NullValueHandling.Ignore)]
                        public string Entity_type { get; set; } //       The entity type of the entities we will spawn in this step

                        [JsonProperty(PropertyName = "num_entities_spawned", NullValueHandling = NullValueHandling.Ignore)]
                        ...
                        [JsonProperty(PropertyName = "summon_cap", NullValueHandling = NullValueHandling.Ignore)]
                        public int summon_cap { get; set; } // Integer  0	Maximum number of summoned entities at any given time

                        [JsonProperty(PropertyName = "summon_cap_radius", NullValueHandling = NullValueHandling.Ignore)]
